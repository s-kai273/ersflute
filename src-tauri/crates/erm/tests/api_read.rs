                ...
                tables: Some(vec![
                    diagram_walkers::Table {
                        ...
                        columns: diagram_walkers::Columns {
                            items: Some(vec![
                                diagram_walkers::ColumnItem::Normal(
                                ...
                                diagram_walkers::ColumnItem::Group("COMMON".to_string()),
                            ]),
                        },
                            ...
                            items: Some(vec![
                                ...
                                diagram_walkers::ColumnItem::Normal(
                                    diagram_walkers::NormalColumn {
                                        ...
                                        referred_column: Some(
                                            "table.MEMBERS.MEMBER_ID".to_string()
                                        ),
                                        relationship: Some(
                                            "FK_MEMBER_PROFILES_MEMBERS".to_string()
                                        ),
                                        not_null: Some(true),
                                        ..Default::default()
                                    }
                                ...
                                diagram_walkers::ColumnItem::Normal(
                                    diagram_walkers::NormalColumn {
                                        ...
                                        referred_column: Some(
                                            "table.MST_GENDER.GENDER_ID".to_string()
                                        ),
                                        relationship: Some(
                                            "FK_MEMBER_PROFILES_MST_GENDER".to_string()
                                        ),
                                        ..Default::default()
                                    }
                                ),
                            ...
                            items: Some(vec![
                                ...
                                diagram_walkers::ColumnItem::Normal(
                                    diagram_walkers::NormalColumn {
                                        ...
                                        relationship: Some(
                                            "FK_POST_REPLIES_POST_THREADS".to_string()
                                        ),
                                        not_null: Some(true),
                                        ..Default::default()
                                    }
                            ...
                            items: Some(vec![
                                ...
                                diagram_walkers::ColumnItem::Normal(
                                    diagram_walkers::NormalColumn {
                                        ...
                                        relationship: Some(
                                            "FK_POST_THREADS_MEMBER_POSTS".to_string()
                                        ),
                                        not_null: Some(true),
